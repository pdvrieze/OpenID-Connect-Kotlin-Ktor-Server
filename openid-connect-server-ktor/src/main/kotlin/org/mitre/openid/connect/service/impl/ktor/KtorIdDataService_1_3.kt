...
class KtorIdDataService_1_3(
    ...
    fun toSerialConfig(): KtorIdDataService.ExtendedConfiguration12 {
        val newClients = clientRepository.allClients.map { KtorIdDataService.ClientDetailsConfiguration(ClientDetailsEntity.from(it)) }
        return KtorIdDataService.ExtendedConfiguration12(
            clients = newClients,
            ...
            authenticationHolders = authHolderRepository.all.map { KtorAuthenticationHolder.SerialDelegate12(it) },
    ...
    companion object {
        private val logger = getLogger<KtorIdDataService_1_3>()
        internal const val THIS_VERSION = KtorIdDataService.MITREID_CONNECT_1_3
    }
}
