...
enum class OAuthErrorCodes(val code: String, val httpCode: HttpStatusCode?, vararg val scopes: Scope) {
     ...
     * Request) status code.
     */
    INVALID_REQUEST("invalid_request", HttpStatusCode.BadRequest, Scope.ACCESS_TOKEN_ISSUE, Scope.BEARER_TOKEN_USE, Scope.ACCESS_REQUEST),
     ...
     * used by the client.
     */
    INVALID_CLIENT("invalid_client", HttpStatusCode.BadRequest, Scope.ACCESS_TOKEN_ISSUE),
     ...
     */
    INVALID_GRANT("invalid_grant", HttpStatusCode.BadRequest, Scope.ACCESS_TOKEN_ISSUE),
     ...
     */
    INVALID_TOKEN("invalid_token", HttpStatusCode.Unauthorized, Scope.BEARER_TOKEN_USE),

    /**
     * The client is not authorized to request an authorization code using this method.
     */
    UNAUTHORIZED_CLIENT("unauthorized_client", HttpStatusCode.BadRequest, Scope.ACCESS_TOKEN_ISSUE, Scope.ACCESS_REQUEST),

    /**
     * The authorization grant type is not supported by the authorization server.
     */
    UNSUPPORTED_GRANT_TYPE("unsupported_grant_type", HttpStatusCode.BadRequest, Scope.ACCESS_TOKEN_ISSUE),
     ...
     */
    INSUFFICIENT_SCOPE("insufficient_scope", HttpStatusCode.Forbidden, Scope.BEARER_TOKEN_USE),

    /**
     * The authorization server does not support obtaining an authorization code using this method.
     */
    UNSUPPORTED_RESPONSE_TYPE("unsupported_response_type", HttpStatusCode.BadRequest, Scope.ACCESS_REQUEST),

    /**
     * The resource owner or authorization server denied the request.
     */
    ACCESS_DENIED("access_denied", HttpStatusCode.Forbidden, Scope.ACCESS_REQUEST),
     ...
     */
    UNSUPPORTED_TOKEN_TYPE("unsupported_token_type", HttpStatusCode.BadRequest, Scope.TOKEN_REVOCATION),

    /**
     * The requested scope is invalid, unknown, or malformed.
     */
    INVALID_SCOPE("invalid_scope", HttpStatusCode.BadRequest, Scope.ACCESS_TOKEN_ISSUE, Scope.ACCESS_REQUEST),

    /**
     * The value of one or more redirection URIs is invalid.
     * @see RFC 7591 Section 3.2.2
     */
    INVALID_REDIRECT_URI("invalid_redirect_uri", HttpStatusCode.BadRequest, Scope.DYNAMIC_REGISTRATION),
     ...
     */
    INVALID_CLIENT_METADATA("invalid_client_metadata", HttpStatusCode.BadRequest, Scope.DYNAMIC_REGISTRATION),

    /**
     * The software statement presented is invalid.
     */
    INVALID_SOFTWARE_STATEMENT("invalid_software_statement", HttpStatusCode.BadRequest, Scope.DYNAMIC_REGISTRATION),

    /**
     * The software statement presented is not approved for use by this authorization server.
     */
    UNAPPROVED_SOFTWARE_STATEMENT("unapproved_software_statement", HttpStatusCode.BadRequest, Scope.DYNAMIC_REGISTRATION),
     ...
     */
    SERVER_ERROR("server_error", HttpStatusCode.InternalServerError, Scope.ACCESS_REQUEST),
     ...
     */
    TEMPORARILY_UNAVAILABLE("temporarily_unavailable", HttpStatusCode.ServiceUnavailable, Scope.ACCESS_REQUEST),
    ;

    constructor(code: String, vararg scopes: Scope): this(code, null, *scopes)
