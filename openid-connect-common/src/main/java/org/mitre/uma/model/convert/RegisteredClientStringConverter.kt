 ...
 */
@Converter
class RegisteredClientStringConverter : AttributeConverter<RegisteredClient?, String?> {
    override fun convertToDatabaseColumn(attribute: RegisteredClient?): String? {
        return attribute?.source?.toString()
    }
