...
inline fun <T, C : TagConsumer<T>> C.baseView(context: WebContext, title: String, pageName: String, hasSideBar: Boolean = false, crossinline content: DIV.(WebContext) -> Unit): T {
