...
//				when(_auth.getId()).thenReturn(id);
    ...
    fun testImportClients() {
        ...
        Assertions.assertEquals(client1.getAccessTokenValiditySeconds(), savedClients[0].getAccessTokenValiditySeconds())
        Assertions.assertEquals(client1.getClientId(), savedClients[0].getClientId())
        Assertions.assertEquals(client1.getClientSecret(), savedClients[0].getClientSecret())
        Assertions.assertEquals(client1.redirectUris, savedClients[0].redirectUris)
        Assertions.assertEquals(client1.getScope(), savedClients[0].getScope())
        ...
        Assertions.assertEquals(client2.getAccessTokenValiditySeconds(), savedClients[1].getAccessTokenValiditySeconds())
        Assertions.assertEquals(client2.getClientId(), savedClients[1].getClientId())
        Assertions.assertEquals(client2.getClientSecret(), savedClients[1].getClientSecret())
        Assertions.assertEquals(client2.redirectUris, savedClients[1].redirectUris)
        Assertions.assertEquals(client2.getScope(), savedClients[1].getScope())
